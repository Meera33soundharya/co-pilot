  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm relative overflow-hidden">
      ...
      <div className="flex flex-col gap-6">
          ...
          <div className="space-y-2">
            {draft.map(d => (
              <div key={d.id} className="p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:border-red-100 transition-colors">
                ...
                <div className="text-base font-bold text-gray-500">{d.source} &middot; Due {d.due}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="text-base font-black uppercase text-gray-400 mb-2">Approved</div>
          <div className="space-y-2">
            {approved.map(a => (
              <div key={a.id} className="p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:border-red-100 transition-colors">
                ...
                <div className="text-base font-bold text-gray-500">{a.source}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="text-base font-black uppercase text-gray-400 mb-2">Published</div>
          <div className="space-y-2">
            {published.map(p => (
              <div key={p.id} className="p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:border-red-100 transition-colors">
                ...
                <div className="text-base font-bold text-gray-500">{p.source}</div>
              </div>
            ))}
          </div>
        </div>

    ...
    <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm relative overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-lg">
          <thead className="text-base text-gray-500 uppercase">
            <tr>
          ...
          <tbody>
            {mock.map(u => (
              <tr key={u.id} className="border-t hover:bg-gray-50">
                ...
                <td className="p-2">
                  <button className="px-4 py-1.5 rounded-xl bg-white border border-gray-200 text-base font-black uppercase tracking-widest hover:bg-red-50 hover:text-red-700 hover:border-red-100 transition-all shadow-sm">
                    Edit
                  </button>
                </td>
              </tr>

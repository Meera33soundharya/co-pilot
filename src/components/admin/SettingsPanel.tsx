      ...
      <div className="space-y-3 text-sm text-gray-600">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-gray-400">Push updates to dashboards and portals</div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-gray-400">Run predictive models and anomaly detection</div>
          </div>
          <input type="checkbox" defaultChecked />
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-gray-400">Keep full immutable audit trail</div>
          </div>
          <input type="checkbox" defaultChecked />
        </div>
      </div>

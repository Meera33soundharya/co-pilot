        ...
        <div className="relative rounded-3xl overflow-hidden border border-white/5 shadow-2xl" style={{ background: 'linear-gradient(135deg, #060D1A 0%, #0B1221 40%, #0d1a35 70%, #091628 100%)' }}>
            ...
            <div className="relative z-10 border-b border-white/5 px-8 py-3 flex items-center gap-4 bg-white/[0.03] backdrop-blur-sm">
                <div className="flex items-center gap-2.5 shrink-0">
                    ...
                    <span className="text-sm font-bold uppercase tracking-[0.2em] text-white/40">Live Updates</span>
                </div>
                <div className="flex-1 overflow-hidden">
                    <div key={tick} className="animate-fade-in flex items-center gap-3">
                        <span className={`text-sm font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-lg bg-white/5 border border-white/10 ${tickerItems[tick].color} shadow-sm`}>
                            {tickerItems[tick].status}
                        </span>
                        <span className="text-lg font-medium text-white/50 tracking-tight">{tickerItems[tick].label}</span>
                    </div>
                </div>
                <div className="text-sm font-bold text-white/20 uppercase tracking-widest shrink-0 hidden md:block tabular-nums">
            ...
            <div className="relative z-10 px-8 py-8 flex flex-col xl:flex-row xl:items-center gap-8">
                ...
                <div className="flex-1 min-w-0 space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold uppercase tracking-[0.3em] text-[#D4AF37] opacity-90">
                            Main Overview
                        </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-2">
                        <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-rose-500/10 border border-rose-500/20 shadow-lg shadow-rose-900/10">
                            ...
                            <span className="text-base font-bold text-white uppercase tracking-widest">7 Bad Issues</span>
                        ...
                        <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                            ...
                            <span className="text-base font-bold text-white uppercase tracking-widest">Integrity Optimal</span>
                        </div>
                        <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-blue-500/10 border border-blue-500/20">
                            <Bell className="w-4 h-4 text-blue-400" />
                            <span className="text-base font-bold text-white uppercase tracking-widest">24 Mentions</span>
                        </div>
                        <button
                        ...
                        >
                            ...
                            <span className="text-base uppercase tracking-widest">Ask AI</span>
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 shrink-0 xl:w-80">
                    {liveStats.map((stat) => (
                        ...
                        >
                            ...
                            <p className="text-sm font-bold uppercase tracking-[0.2em] text-white/30 mt-2 relative z-10">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="relative z-10 border-t border-white/5 px-8 py-4 flex items-center gap-8 bg-white/[0.02]">
                {[
                    ...
                    <div key={s.label} className="flex items-center gap-4 flex-1">
                        <span className="text-sm font-bold uppercase tracking-widest text-white/20 whitespace-nowrap hidden sm:block">{s.label}</span>
                        ...
                        <span className="text-base font-extrabold tabular-nums" style={{ color: s.color }}>{s.value}%</span>
                    </div>
                ))}
            </div>
        </div>

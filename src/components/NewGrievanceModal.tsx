            ...
            <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-slide-up">
                ...
                <div className="px-7 py-6 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm font-bold uppercase tracking-widest text-gray-400 mt-0.5">Citizen complaint submission</p>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                {step === "form" && (
                    <form onSubmit={handleSubmit} className="p-7 space-y-5 max-h-[70vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-lg font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white focus:border-blue-300 transition-all placeholder:text-gray-400"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="flex items-center gap-1.5 text-sm font-black uppercase tracking-widest text-gray-500">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-lg font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white focus:border-blue-300 transition-all"
                                >
                                ...
                                {priorities.map(p => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 py-2.5 rounded-xl border text-base font-black uppercase tracking-widest transition-all ${colors[p as keyof typeof colors]} ${form.priority === p ? active[p as keyof typeof active] : "opacity-50"}`}
                                        >
                                            {p}
                                        </button>
                                    );
                        ...
                        {/* Issue Title */}
                        <div className="space-y-1.5">
                            <label className="text-sm font-black uppercase tracking-widest text-gray-500">Issue Title *</label>
                            <input
                                required
                                value={form.issue}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-lg font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white focus:border-blue-300 transition-all placeholder:text-gray-400 resize-none"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-lg font-black uppercase tracking-widest transition-all shadow-xl shadow-blue-500/20 active:scale-[0.98]"
                        >
                            Submit Grievance
                        </button>
                    </form>
                ...
                {step === "loading" && (
                    <div className="p-12 flex flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-lg font-bold text-gray-600">Submitting grievance...</p>
                        <p className="text-sm font-bold uppercase tracking-widest text-gray-400">AI triage in progress</p>
                    </div>
                )}
                ...
                {step === "success" && (
                    <div className="p-10 flex flex-col items-center justify-center gap-5 text-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-500 font-medium">Your ticket has been registered</p>
                        </div>
                        <div className="px-6 py-4 bg-blue-50 border border-blue-100 rounded-2xl w-full">
                            <p className="text-sm font-black uppercase tracking-widest text-blue-400 mb-1">Ticket ID</p>
                            <p className="text-2xl font-black text-blue-600 font-mono">{ticketId}</p>
                            <p className="text-sm text-gray-400 font-bold mt-1">AI has auto-triaged to {form.dept}</p>
                        </div>
                        <button
                            onClick={handleClose}
                            className="w-full py-3 bg-gray-900 text-white rounded-2xl text-lg font-black uppercase tracking-widest hover:bg-gray-800 transition-all active:scale-95"
                        >
                            Done
                        </button>
                    </div>

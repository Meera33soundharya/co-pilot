            ...
            <div className="space-y-8 pb-12">
                ...
                <div className="bg-gradient-to-r from-red-600 to-gray-900 rounded-[2.5rem] p-8 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-lg">Reviewing recommendation for: <span className="text-white font-black underline underline-offset-4 decoration-red-400">Ward 03 Resource Reallocation</span></p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <div className="text-right hidden md:block">
                            <p className="text-base font-black uppercase">Internal Audit ID</p>
                            <p className="font-mono text-lg opacity-60">XAI-992-ALPHA</p>
                        </div>
                        <div className="w-px h-10 bg-white/20 mx-4 hidden md:block" />
                        <span className="px-4 py-2 bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 rounded-xl text-sm font-black uppercase tracking-widest">
                        ...
                        {reasoningSteps.map((step, idx) => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className={`text-sm font-black uppercase tracking-widest mb-1 ${selectedStep === idx ? "text-red-600" : "text-gray-400"
                                        }`}>Step 0{idx + 1}</h4>
                        ...
                        <div className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm h-full flex flex-col">
                            <div className="flex items-start justify-between mb-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-400 font-bold uppercase tracking-widest mt-1">Deep Analysis Node</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-xl text-sm font-black text-gray-400 uppercase tracking-widest border border-gray-100">
                            ...
                            <div className="flex-1 space-y-8">
                                <div className="p-8 bg-red-50/50 rounded-3xl border border-red-100 relative">
                                    ...
                                    <h4 className="text-sm font-black uppercase tracking-widest text-[#B91C1C] mb-4">Finding Summary</h4>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                        <h4 className="text-sm font-black uppercase tracking-widest text-gray-400 mb-3">Confidence Intervals</h4>
                            ...
                            <div className="mt-12 flex items-center justify-between pt-8 border-t border-gray-100">
                                <div className="flex -space-x-3">
                                    {[1, 2, 3].map(i => (
                                        <div key={i} className="w-10 h-10 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-sm font-black text-gray-500">
                                            JD
                                        </div>
                                    ))}
                                    <div className="w-10 h-10 rounded-full bg-red-600 border-2 border-white flex items-center justify-center text-sm font-black text-white">
                                        +4
                                    </div>
                                </div>
                                <button className="px-8 py-4 bg-gray-900 text-white rounded-2xl text-sm font-black uppercase tracking-widest hover:bg-gray-800 transition-all flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-black uppercase text-gray-400 tracking-widest">Transparency Compliance</p>
                    ...
                    <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-black uppercase text-gray-400 tracking-widest">Bias Monitoring</p>
                    ...
                    <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-black uppercase text-gray-400 tracking-widest">Decisions Audited</p>

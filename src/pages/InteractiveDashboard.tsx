                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                        <div className="flex items-center gap-8">
                            ...
                            <div className="space-y-1">
                                <h1 className="text-3xl font-black tracking-tight">{activeZone} <span className="text-white/30 text-lg font-bold uppercase tracking-[0.3em] ml-2">Monitor</span></h1>
                                <div className="flex items-center gap-6">
                                    <div className="flex items-center gap-2">
                                        <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                                        <span className="text-sm font-black uppercase tracking-widest text-emerald-400">Sector Integrity: {integrity}%</span>
                                    </div>
                                    <div className="w-1 h-1 rounded-full bg-white/10" />
                                    <span className="text-sm font-black uppercase tracking-widest text-white/30">{zoneWards.length} Active Nodes (Wards)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-3 bg-white/5 p-2 rounded-3xl border border-white/10 backdrop-blur-md">
                            {Object.keys(ZONES).map(zone => (
                                <button
                                    ...
                                    className={`px-8 py-3.5 rounded-2xl text-sm font-black uppercase tracking-widest transition-all duration-300 ${activeZone === zone
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
                    ...
                    <div className="xl:col-span-3 bg-white border border-gray-100 rounded-[3rem] p-10 shadow-sm min-h-[550px] relative overflow-hidden group/map">
                        ...
                        <div className="flex items-center justify-between mb-12 relative z-10">
                            <div>
                                <h3 className="text-lg font-black text-gray-900 flex items-center gap-3 uppercase tracking-widest">
                                    <Map className="w-5 h-5 text-[#B91C1C]" />
                                    Tactical Node Intelligence
                                </h3>
                                <p className="text-sm font-black text-gray-400 uppercase tracking-widest mt-1">Satellite View Overlay: Active Wards In {activeZone}</p>
                            </div>
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            <div className="space-y-0.5">
                                                <p className={`text-sm font-black uppercase tracking-widest ${isHottest ? "text-white/60" : "text-gray-400"}`}>Node</p>
                                                <p className="text-lg font-black">{w}</p>
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <p className={`text-sm font-black uppercase tracking-widest ${isHottest ? "text-white/70" : "text-gray-400"}`}>Active Events</p>
                                            </div>
                                        </div>
                                    </div>
                                );
                        ...
                        <div className="mt-12 bg-[#060912] rounded-[2rem] p-6 shadow-2xl relative z-20 border border-white/5 overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <p className="text-sm font-black uppercase tracking-widest text-rose-500">Live Strategic Feed</p>
                                        </div>
                                        <p className="text-lg font-bold text-white/90 italic mt-0.5 tracking-tight px-1">
                                            {critical > 0 
                                ...
                                <button className="px-8 py-3 bg-white text-gray-900 rounded-2xl text-sm font-black uppercase tracking-widest hover:bg-red-50 transition-all flex items-center gap-2 border border-white shadow-xl">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={stat.label} className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm hover:scale-[1.02] transition-transform duration-300 group relative overflow-hidden">
                                ...
                                <p className="text-sm font-black uppercase tracking-widest text-gray-500 mb-3">{stat.label}</p>
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-[#121212] rounded-[3rem] p-10 text-white shadow-2xl border border-white/5">
                            <h3 className="text-base font-black uppercase tracking-[0.3em] text-white/30 mb-4">Tactical Summary</h3>
                            <p className="text-base text-white/60 leading-relaxed italic">Currently monitoring all sectors with active AI predictive mapping. Sector integrity is linked to the central Governance Core.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 rounded-[3.5rem] p-16 shadow-sm relative overflow-hidden group/manual">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="flex flex-col items-center text-center mb-16 space-y-4">
                            <div className="inline-flex items-center gap-3 px-6 py-2 bg-red-50 text-[#B91C1C] rounded-full text-sm font-black uppercase tracking-[0.4em] border border-red-100 shadow-sm">
                            ...
                            <p className="text-base text-gray-400 font-black uppercase tracking-[0.3em] max-w-sm">Standard Operating Procedures for District-Level Command Units</p>
                        </div>
                                ...
                                return (
                                    <div key={i} className="space-y-6 group/step">
                                        ...
                                        <div className="space-y-3">
                                            <h4 className="text-lg font-black text-gray-900 uppercase tracking-tighter group-hover/step:text-[#B91C1C] transition-colors italic">{s.title}</h4>
                        ...
                        <div className="mt-20 pt-16 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-10">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <p className="text-sm font-black uppercase text-gray-400 tracking-widest mb-1 italic">Security Status</p>
                                    <p className="text-lg font-black text-gray-900 uppercase tracking-tight">Encryption Core Synchronized</p>
                                </div>
                            </div>
                            <button className="px-10 py-5 bg-gray-900 text-white rounded-3xl text-sm font-black uppercase tracking-[0.4em] hover:bg-[#B91C1C] transition-all shadow-2xl shadow-gray-950/20 active:scale-95">

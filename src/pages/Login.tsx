...
import {
    ...
    MessageSquare, BrainCircuit, Sparkles, ChevronRight, Languages
} from "lucide-react";
...
const ACCOUNTS = [
    {
        role: "admin" as const, labelKey: "login_admin_label", descKey: "login_admin_desc", icon: Shield,
    ...
    {
        role: "officer" as const, labelKey: "login_officer_label", descKey: "login_officer_desc", icon: Building2,
    ...
    {
        role: "citizen" as const, labelKey: "login_citizen_label", descKey: "login_citizen_desc", icon: User,
...
export default function Login() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSelected(user);
            setTimeout(() => { setLoading(false); setBooting(true); }, 300);
        } catch (err: any) {
            setLoading(false);
                ...
                <div className="w-full max-w-[420px] space-y-6">
                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 bg-white hover:bg-red-50 hover:border-red-300 hover:text-[#C62828] text-gray-500 transition-all text-xs font-black uppercase tracking-wide"
                        >
                    ...
                    {/* Heading */}
                    <div>
                        <h2 className="text-3xl font-black text-gray-900 tracking-tight">{t("login_welcome")}</h2>
                        <p className="text-gray-500 text-sm font-medium mt-1">{t("login_subtitle")}</p>
                    </div>

                    {/* Quick role selector */}
                    <div>
                        <p className="section-label mb-3">{t("login_quickAccess")}</p>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-sm">
                        <form onSubmit={handleLogin} className="space-y-4" noValidate>
                            ...
                            <div className="space-y-1.5">
                                <label className="section-label ml-0.5">{t("login_officialEmail")}</label>
                            ...
                            {/* Password */}
                            <div className="space-y-1.5">
                                <label className="section-label ml-0.5">{t("login_password")}</label>
                                <div className="relative group">
                            ...
                            >
                                {loading
                                    ...
                                    : <>{t("login_signIn")} <ArrowRight className="w-4 h-4" /></>
                                }
                            </button>
                        </form>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100">
                            ...
                            >
                                ...
                                {t("login_submitComplaint")}
                                <ChevronRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
                            </a>
                        </div>

                        {/* Voice Only / Elderly Portal link */}
                        <div className="mt-3">
                            <button
                                onClick={(e) => { e.preventDefault(); navigate('/voice-portal'); }}
                                className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50 text-emerald-700 text-xs font-black uppercase tracking-widest hover:border-emerald-300 hover:bg-emerald-100 transition-all group cursor-pointer"
                            >
                                <Mic className="w-4 h-4 group-hover:scale-110 transition-transform" />
                                {lang === "ta" ? "முதியோர் / குரல் பதிவு மையம்" : "Elderly / Voice Only Portal"}
                                <ChevronRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
                            </button>
                        </div>
                    </div>

                    ...
                    <div className="flex items-center gap-2">
                        {["All", "open", "in progress", "resolved", "closed"].map(f => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-[11px] font-medium uppercase tracking-wider transition-colors ${filter === f
                            ...
                            >
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">{c.citizen ?? "Unknown"} · {c.category} · {c.ward}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-full ${c.priority === "High" ? "bg-red-900/30 text-red-500 border border-red-800" :
                                    ...
                                    <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-full ${c.status === "Pending" || c.status === "Assigned" ? "bg-blue-900/30 text-blue-500 border border-blue-800" :

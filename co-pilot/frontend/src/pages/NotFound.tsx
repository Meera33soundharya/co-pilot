        ...
        <div className="min-h-screen bg-[#F5F0E8] flex items-center justify-center p-6 font-sans">
            <div className="max-w-md w-full text-center space-y-8 animate-fade-in">
                ...
                <div className="relative mx-auto w-32 h-32">
                    ...
                    <div className="absolute inset-0 bg-[#B91C1C] rounded-3xl flex items-center justify-center shadow-2xl shadow-red-900/30 rotate-12 transition-transform duration-500">
